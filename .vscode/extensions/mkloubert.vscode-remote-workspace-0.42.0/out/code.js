 ...
 */
function exec(_13ce0f874dea43478cb76f552fbe2069_tmmk_0509_2309_1979) {
    // s. https://lodash.com/
    ...
    const $r = (id) => {
        return require($h.toStringSafe(id));
    };
    const $v = {};
    if (!_.isNil(_13ce0f874dea43478cb76f552fbe2069_tmmk_0509_2309_1979.values)) {
        // additional values, which should
        // be written to $v
        _.forIn(_13ce0f874dea43478cb76f552fbe2069_tmmk_0509_2309_1979.values, (v, k) => {
            $v[$h.normalizeString(k)] = v;
        });
    }
    return eval($h.toStringSafe(_13ce0f874dea43478cb76f552fbe2069_tmmk_0509_2309_1979.code));
}
exports.exec = exec;
